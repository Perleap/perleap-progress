...
const Pricing = () => {
  ...
  const [selectedBeginnerCredits, setSelectedBeginnerCredits] = useState(pricingPlans.beginner.defaultCredits);
  const [selectedProCredits, setSelectedProCredits] = useState(pricingPlans.pro.defaultCredits);
  const [selectedBusinessCredits, setSelectedBusinessCredits] = useState(pricingPlans.business.defaultCredits);
      ...
      <div className="container mx-auto px-4 pt-32 pb-16 max-w-7xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="bg-card border-border relative hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="text-foreground text-2xl">{pricingPlans.beginner.name}</CardTitle>
              <CardDescription className="text-muted-foreground pt-2">
                {pricingPlans.beginner.description}
              </CardDescription>
              <div className="pt-6">
                <div className="flex items-baseline gap-2">
                  <span className="text-5xl font-bold text-foreground">${pricingPlans.beginner.monthlyPrice}</span>
            ...
            <CardContent className="space-y-4">
              ...
              <Select value={selectedBeginnerCredits.toString()} onValueChange={(value) => setSelectedBeginnerCredits(Number(value))}>
          ...
          {/* Pro Plan */}
          <Card className={`bg-card border-border relative hover:shadow-lg transition-shadow ${pricingPlans.pro.highlighted ? 'ring-2 ring-primary shadow-xl' : ''}`}>
            ...
            <CardHeader>
              ...
              <div className="pt-6">
                <div className="flex items-baseline gap-2">
                  <span className="text-5xl font-bold text-foreground">${pricingPlans.pro.monthlyPrice}</span>
                  <span className="text-muted-foreground">per month</span>
                </div>
                <p className="text-sm text-muted-foreground mt-2">shared across unlimited users</p>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <Select value={selectedProCredits.toString()} onValueChange={(value) => setSelectedProCredits(Number(value))}>
                <SelectTrigger className="w-full">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
              ...
              <div className="pt-4">
                <h4 className="text-foreground font-semibold mb-3">All features in Beginner, plus:</h4>
                <TooltipProvider>
                  <ul className="space-y-3">
          ...
          <Card className="bg-card border-border relative hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="text-foreground text-2xl">{pricingPlans.business.name}</CardTitle>
              <CardDescription className="text-muted-foreground pt-2">
                {pricingPlans.business.description}
              </CardDescription>
              <div className="pt-6">
                <div className="flex items-baseline gap-2">
                  <span className="text-5xl font-bold text-foreground">${pricingPlans.business.monthlyPrice}</span>
                  <span className="text-muted-foreground">per month</span>
                </div>
                <p className="text-sm text-muted-foreground mt-2">shared across unlimited users</p>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <Select value={selectedBusinessCredits.toString()} onValueChange={(value) => setSelectedBusinessCredits(Number(value))}>
                <SelectTrigger className="w-full">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <Card className="bg-card border-border relative hover:shadow-lg transition-shadow">
            <CardHeader>
              <CardTitle className="text-foreground text-2xl">{pricingPlans.enterprise.name}</CardTitle>
              <CardDescription className="text-muted-foreground pt-2">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="pt-4">
                <h4 className="text-foreground font-semibold mb-3">All features in Business, plus:</h4>
                <ul className="space-y-3">
