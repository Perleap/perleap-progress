...
export type UpdateSyllabusInput = Partial<
  Omit<Syllabus, 'id' | 'classroom_id' | 'created_at' | 'updated_at'>
>;
...
export type UpdateSyllabusSectionInput = Partial<
  Omit<SyllabusSection, 'id' | 'syllabus_id' | 'created_at' | 'updated_at'>
>;
export type CreateGradingCategoryInput = Omit<GradingCategory, 'id' | 'created_at' | 'updated_at'>;
export type UpdateGradingCategoryInput = Partial<
  Omit<GradingCategory, 'id' | 'syllabus_id' | 'created_at' | 'updated_at'>
>;
...
export type UpdateSectionResourceInput = Partial<
  Omit<SectionResource, 'id' | 'section_id' | 'created_at' | 'updated_at'>
>;
