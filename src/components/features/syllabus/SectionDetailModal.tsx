...
export const SectionDetailModal = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="max-w-2xl max-h-[85vh] p-0 rounded-2xl overflow-hidden flex flex-col"
        dir={isRTL ? 'rtl' : 'ltr'}
      >
          ...
          <DialogHeader>
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1 min-w-0">
                <DialogTitle
                  className={cn('text-xl font-bold text-foreground mb-2', isRTL && 'text-right')}
                >
                  {section.title}
                </DialogTitle>
                <div
        ...
        <ScrollArea className="flex-1 overflow-y-auto max-h-[calc(85vh-120px)]">
          <div className="px-6 py-5 space-y-6">
            ...
            {/* Resources */}
            {resources.length > 0 && <ResourceViewer resources={resources} isRTL={isRTL} />}
