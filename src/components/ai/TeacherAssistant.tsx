...
export function TeacherAssistant() {
    ...
    return (
        <>
            ...
            {isOpen && (
                <Card className="fixed bottom-24 right-6 w-[90vw] md:w-96 h-[500px] max-h-[80vh] shadow-2xl z-50 flex flex-col animate-in fade-in slide-in-from-bottom-10 border-indigo-100 dark:border-indigo-900 overflow-hidden">
                    ...
                    <CardHeader className="flex flex-row items-center justify-between pb-3 py-3 border-b bg-slate-50/50 dark:bg-slate-900/50">
                        ...
                        <Button variant="ghost" size="icon" className="h-7 w-7 text-muted-foreground hover:text-red-500" onClick={clearChat} title="Clear Chat">
                            ...
                            <div className="space-y-4 min-h-full">
                                {messages.length === 0 && (
                                    <div className="flex flex-col items-center justify-center h-full text-center p-6 text-muted-foreground bg-white/50 dark:bg-slate-800/50 rounded-xl my-8 mx-2 border border-dashed">
                                        ...
                                        <p className="text-xs mt-2 opacity-70">Ask about lesson plans, rubrics, or classroom activities.</p>
                                    </div>
                                )}
                                {messages.map((m, i) => (
