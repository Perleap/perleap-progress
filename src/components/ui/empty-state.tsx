...
export const EmptyState = ({
  ...
  return (
    <div
      className={cn(
        'flex flex-col items-center justify-center py-20 px-4 animate-in fade-in slide-in-from-bottom-4 duration-700',
        className
      )}
    >
      ...
      <h3 className="text-2xl font-bold mb-3 text-center bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text animate-in fade-in duration-500 delay-300">
        {title}
      </h3>
      <p className="text-muted-foreground text-center max-w-md mb-8 text-base animate-in fade-in duration-500 delay-400">
        {description}
      </p>
      {action && (
        <Button
