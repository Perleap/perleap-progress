...
const InputOTPGroup = ({ className, ...props }: React.ComponentProps<'div'>) => {
  return (
    <div
      ...
      className={cn(
        'has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive rounded-4xl has-aria-invalid:ring-[1.5px] flex items-center',
        className
      )}
      {...props}
    />
