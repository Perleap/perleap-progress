-- Teacher preview submissions should not appear in the classroom activity feed.
...
BEGIN
  IF (TG_OP = 'INSERT' AND NEW.status = 'completed') OR
    ...
    v_use_teacher_label := v_teacher_id IS NOT NULL AND NEW.student_id = v_teacher_id;
